...
// // // // 	CommitteeName       string  `json:"committee_name,omitempty"`
// // // // 	EventName           string  `json:"event_name,omitempty"`
// // // // 	FacultyApproverName *string `json:"faculty_approver_name,omitempty"`
// // // // }
...
// // // 	AttendanceID int64 `json:"attendance_id"`
// // // 	ApprovedBy   int64 `json:"approved_by"` // faculty.id or admin.id
// // // }
...
// // // // 	Approved     bool       `json:"approved"`
// // // // 	ApprovedBy   *int64     `json:"approved_by"` // Ptr for nullable
// // // // 	ApprovedAt   *time.Time `json:"approved_at"` // Ptr for nullable

// // // //		// Enriched fields for responses (assuming these are populated by joins)
// // // //		VolunteerID         int64   `json:"volunteer_id,omitempty"` // Added for completeness, might be from join
// // // //		CommitteeID         int64   `json:"committee_id,omitempty"` // Added for completeness, might be from join
// // // //		EventID             int64   `json:"event_id,omitempty"`     // Added for completeness, might be from join
// // // //		VolunteerName       string  `json:"volunteer_name,omitempty"`
// // // //		CommitteeName       string  `json:"committee_name,omitempty"`
// // // //		EventName           string  `json:"event_name,omitempty"`
// // // //		FacultyApproverName *string `json:"faculty_approver_name,omitempty"` // Ptr for nullable
// // // //	}
// // // //
// // // // In models/models.go (Ensure these fields are present and correctly typed)
// // // type Attendance struct {
// // // 	ID           int64      `json:"id"`
// // // 	AssignmentID int64      `json:"assignment_id"`
// // // 	CheckInTime  time.Time  `json:"check_in_time"`
...
// // // 	// Enriched fields for responses (populated by joins)
// // // 	VolunteerID         int64   `json:"volunteer_id,omitempty"` // Added/Confirmed for ListAll/Export
// // // 	CommitteeID         int64   `json:"committee_id,omitempty"` // Added/Confirmed for ListAll/Export
// // // 	EventID             int64   `json:"event_id,omitempty"`     // Added/Confirmed for ListAll/Export
// // // 	VolunteerName       string  `json:"volunteer_name,omitempty"`
// // // 	CommitteeName       string  `json:"committee_name,omitempty"`
// // // 	EventName           string  `json:"event_name,omitempty"`
// // // 	FacultyApproverName *string `json:"faculty_approver_name,omitempty"`
...
// // // // NEW: Struct for the revised Pending endpoint
// // // type PendingAssignmentRow struct {
// // // 	AssignmentID     int64            `json:"assignment_id"`
// // // 	EventID          int64            `json:"event_id"`
...
// // // Updated Attendance struct (no approval fields)
// // type Attendance struct {
// // 	ID           int64      `json:"id"`
// // 	AssignmentID int64      `json:"assignment_id"`
// // 	CheckInTime  time.Time  `json:"check_in_time"`
...
// // // ApproveAttendanceRequest is no longer used due to removal of approval system
// // // type ApproveAttendanceRequest struct {
// // // 	AttendanceID int64 `json:"attendance_id"`
// // // 	ApprovedBy   int64 `json:"approved_by"` // faculty.id or admin.id
// // // }
...
// //		Shift              *string          `json:"shift,omitempty"`
// //		Notes              *string          `json:"notes,omitempty"`
// //		HasCheckIn         bool             `json:"has_check_in"`                   // Indicates if there's *any* check-in for this assignment
// //		IsCheckedInToday   bool             `json:"is_checked_in_today"`            // Indicates if there's an active check-in today
// //		ActiveAttendanceID *int64           `json:"active_attendance_id,omitempty"` // If checked in, its attendance ID
// //	}
// package models
